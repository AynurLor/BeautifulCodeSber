...
class BeautifulCodeApplicationIT {
    ...
    @Test
    public void checkerBracket_IsBracketPlacementCorrect_ReturnsValidResponseEntity() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/checkBrackets").contentType(MediaType.APPLICATION_JSON).content(requestBody)).andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON)).andExpect(jsonPath("$.isCorrect").value(true));
    }

    @Test
    public void checkerBracket_IsBracketPlacementIncorrect_ReturnsInvalidResponseEntity() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/checkBrackets").contentType(MediaType.APPLICATION_JSON).content(requestBody)).andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON)).andExpect(jsonPath("$.isCorrect").value(false));
    }

    @Test
    public void checkerBracket_IsNestedBracketsPlacementCorrect_ReturnsValidResponseEntity() throws Exception {
    ...
    @Test
    public void checkerBracket_IsNestedBracketsPlacementIncorrect_ReturnsInvalidResponseEntity() throws Exception {
    ...
    @Test
    public void checkerBracket_IsEmptyValueInsideBrackets_ReturnsInvalidResponseEntity() throws Exception {
    ...
    public void checkerBracket_LongTextWithBrackets_ReturnsValidResponseEntity() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/checkBrackets").contentType(MediaType.APPLICATION_JSON).content(requestBody)).andExpect(status().isOk()) // Ожидаем HTTP-статус 200 OK
                .andExpect(content().contentType(MediaType.APPLICATION_JSON)).andExpect(jsonPath("$.isCorrect").value(true)); // Проверяем значение поля "isCorrect"
    }
    ...
    public void checkerBracket_EmptyText_ReturnsBadRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/checkBrackets").contentType(MediaType.APPLICATION_JSON).content(requestBody)).andExpect(status().isBadRequest());
    }
